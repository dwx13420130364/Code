...
#define RT_DEVICE_CTRL_SET_VIRTUAL      0x13    	/* enable receive irq */
#define RT_DEVICE_CTRL_CLR_VIRTUAL      0x14    	/* disable receive irq */
#define RT_DEVICE_CTRL_GET_VIRTUAL      0x15

#define RT_DEVICE_FLAG_INT_RX           0x100           /**< INT mode on Rx */
#define RT_DEVICE_FLAG_DMA_RX           0x200           /**< DMA mode on Rx */
#define RT_DEVICE_FLAG_INT_TX           0x400           /**< INT mode on Tx */
#define RT_DEVICE_FLAG_DMA_TX           0x800           /**< DMA mode on Tx */
#define RT_DEVICE_FLAG_VIRTUAL_RX       0x1000           /**< INT mode on Tx */
#define RT_DEVICE_FLAG_VIRTUAL_TX       0x2000           /**< DMA mode on Tx */
...
#define RT_DEVICE_CTRL_BLK_SETGEOME     0x11            /**< set geometry information   */
...
struct rt_device_blk_geometry
{
    ...
    rt_uint32_t block_pos;                              /**< block position to erase */
};
